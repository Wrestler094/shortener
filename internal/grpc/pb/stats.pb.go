...
const file_stats_proto_rawDesc = "" +
	"\n" +
	"\vstats.proto\x12\tshortener\x1a\x1bgoogle/protobuf/empty.proto\"9\n" +
	"\rStatsResponse\x12\x12\n" +
	"\x04urls\x18\x01 \x01(\x05R\x04urls\x12\x14\n" +
	"\x05users\x18\x02 \x01(\x05R\x05users2L\n" +
	"\fStatsService\x12<\n" +
	"\bGetStats\x12\x16.google.protobuf.Empty\x1a\x18.shortener.StatsResponseB6Z4github.com/Wrestler094/shortener/internal/grpc/pb;pbb\x06proto3"
...
var file_stats_proto_goTypes = []any{
	(*StatsResponse)(nil), // 0: shortener.StatsResponse
	(*emptypb.Empty)(nil), // 1: google.protobuf.Empty
}
var file_stats_proto_depIdxs = []int32{
	1, // 0: shortener.StatsService.GetStats:input_type -> google.protobuf.Empty
	0, // 1: shortener.StatsService.GetStats:output_type -> shortener.StatsResponse
